...
const SW_VERSION = 'v1';
const STATIC_CACHE = 'scorehub-static-v1';
const RUNTIME_CACHE = 'scorehub-runtime-v1';
const OFFLINE_URL = 'offline.html';

const PRECACHE = [
  './', 'index.html', 'offline.html', 'manifest.webmanifest',
  'style.css', 'app.js', 'i18n.js', 'pwa.js', 'share.js',
  ...
  'story.html', 'story.js', 'shop.html', 'about.html',
